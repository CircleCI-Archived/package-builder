...
python_release=1
python_versions="2.6.9 2.7.6 2.7.9 2.7.10 2.7.11 2.7.12 3.1.3 3.1.4 3.1.5 3.2.4 3.2.5 3.2.6 3.3.4 3.3.5 3.3.6 3.4.2 3.4.3 3.4.4 3.4.5 3.5.0 3.5.1 3.5.2 pypy-1.9 pypy-2.6.1 pypy-4.0.1 pypy-5.1.1 pypy-5.3.1"

ruby_release=1
ruby_versions="2.0.0-p647 2.1.6 2.1.7 2.1.8 2.1.9 2.2.2 2.2.3 2.2.4 2.2.5 2.3.0 2.3.1"

php_release=5
php_versions="5.5.31 5.5.32 5.5.33 5.5.34 5.5.35 5.6.16 5.6.17 5.6.18 5.6.19 5.6.20 5.6.21 5.6.22 5.6.23 7.0.1 7.0.2 7.0.3 7.0.4 7.0.5 7.0.6 7.0.7 7.0.8 7.0.9 7.0.10 7.0.11"

nodejs_release=1
nodejs_versions="0.12.9 4.0.0 4.1.2 4.2.6 4.3.0 4.5.0 5.0.0 5.1.1 5.2.0 5.3.0 5.4.1 5.5.0 5.6.0 5.7.0 5.8.0 5.9.0 5.10.0 5.12.0 6.1.0 6.2.0 6.2.1 6.2.2 6.3.0 6.3.1 6.4.0 6.5.0 6.6.0"
...
function build_package() {
	...
	php)
	    ...
	    ;;
	nodejs)
	    local install_dir=$pkg_dir/nodejs/v$;
	    ;;
	*)
